...
As for testing the prototype and it's code yourself, go to the **'modelWrapperBLE'** folder and upload the **'modelWrapperBLE.ino'** file with a baud rate of 9600 to your Arduino ESP32 Nano.
